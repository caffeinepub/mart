...
import type { ExternalBlob as _ExternalBlob, Order as _Order, Price as _Price, Product as _Product, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addStore(arg0: Store): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addToCallerCart(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addToCallerCart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async checkoutCallerCart(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.checkoutCallerCart();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerCart(): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async getProductPagination(arg0: bigint, arg1: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductPagination(arg0, arg1);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSearchProducts(arg0: string): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSearchProducts(arg0);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSearchProductsPagination(arg0: string, arg1: bigint, arg2: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSearchProductsPagination(arg0, arg1, arg2);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        products: await from_candid_vec_n13(_uploadFile, _downloadFile, value.products),
